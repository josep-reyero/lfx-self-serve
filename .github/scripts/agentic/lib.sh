...
# Strip Markdown code fences and any prose around a JSON object, leniently. Emits
# the cleaned JSON on stdout, or exits non-zero if nothing parseable is found.
ag_read_agent_json() {
  local path="$1" text
